...
export interface ProviderScanResult {scan_id:string;provider_id:string;provider_name:string;configured:boolean;discovery_mode:'CATALOG_API'|'SEARCH_API'|'CURATED_REQUIRED';candidate_count:number;candidates:ProviderScanCandidate[];warning?:string|null;error?:string|null;scanned_at:string;}
...
export const adminService = {
  ...
  async getProviderScans(){return apiRequest<{latest:ProviderScanResult[];pricing:ProviderPricingAdmin[]}>('/api/admin/provider-scan');},
