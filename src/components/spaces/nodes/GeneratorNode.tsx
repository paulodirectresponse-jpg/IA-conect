...
export const GeneratorNode:React.FC<Props>=({node,capability,models,nodeRun,history,historyIndex,busy,selected,mediaLabel,onHistoryIndexChange,onPatch,onGenerate})=>{
