...
export const SpaceNodeShell:React.FC<Props>=({node,selected,nodeRun,outputTypes,subtitle,children,connectionHint='NONE',onPointerDown,onInputPointerDown,onOutputPointerDown,onLabelChange,onDuplicate,onDelete,onRunFromHere,onInspect})=>{
 ...
 const portVisibility=selected?'visible opacity-100':'invisible opacity-0 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100';
