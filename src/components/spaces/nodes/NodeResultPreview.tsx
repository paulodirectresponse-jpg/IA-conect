...
interface Props{items:NodeOutputHistoryItem[];index:number;onIndexChange:(index:number)=>void;emptyLabel?:string;fullBleed?:boolean;fit?:'cover'|'contain';}

export const NodeResultPreview:React.FC<Props>=({items,index,onIndexChange,emptyLabel='Seu resultado aparecerá aqui',fullBleed=false,fit='cover'})=>{
