  ...
  return <div className="ia-library-hub ia-creative-library pb-10">
    <div className="flex flex-col xl:flex-row gap-5">
      <aside className="ia-library-nav xl:w-[244px] shrink-0 space-y-4">
        <div className="ia-library-heading"><h1>Organização criativa</h1><p>Assets, personagens, produtos e estilos sem duplicar arquivos.</p></div>
