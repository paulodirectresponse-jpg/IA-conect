...
export const VoiceCreateView:React.FC=()=>{
 ...
 const creator=<GeneratorPanel ariaLabel="Gerador de voz"><GeneratorScroll>
  ...
  {!busy&&models.length===0&&<section className="ia-stable-current"><strong>Nenhum modelo de voz disponível</strong><p>Cadastre e publique uma Route V2 com pricing CURRENT e health HEALTHY.</p></section>}
