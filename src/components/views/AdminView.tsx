...
import{Activity,BrainCircuit,Coins,GitBranch,Settings2,Users}from'lucide-react';
...
type AdminTab='overview'|'routing-v2'|'ai'|'finance'|'users'|'system';
...
export const AdminView:React.FC=()=>{
 ...
 const tabs=[
  ...
  {id:'routing-v2'as const,label:'Routing V2',icon:<GitBranch className="w-4 h-4"/>},
 ...
 return <div className="ia-admin space-y-7">
  ...
  <div className={pane(activeTab==='routing-v2')} aria-hidden={activeTab!=='routing-v2'}><AdminRoutingV2/></div>
  <div className={pane(activeTab==='ai')} aria-hidden={activeTab!=='ai'}><AdminAIProvidersHub/></div>

  <div className={pane(activeTab==='finance')} aria-hidden={activeTab!=='finance'}><div className="space-y-4">
  ...
  <div className={pane(activeTab==='users')} aria-hidden={activeTab!=='users'}><div className="space-y-4">
   <AdminUsersDashboard/>
