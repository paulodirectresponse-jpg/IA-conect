...
export const AdminView:React.FC=()=>{
 ...
 const tabs=[
  ...
  {id:'ai-routing'as const,label:'IA & Roteamento',icon:<BrainCircuit className="w-4 h-4"/>},
 ...
 return <div className="ia-admin space-y-7">
  ...
  <div className={pane(activeTab==='ai-routing')} aria-hidden={activeTab!=='ai-routing'}><AdminRoutingV2/></div>
