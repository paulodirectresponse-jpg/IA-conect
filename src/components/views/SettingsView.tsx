        ...
        >
          <div className="space-y-3 text-xs text-zinc-600">
            <p className="leading-relaxed">
              Caso você seja o desenvolvedor ou o administrador inicial desta instância e nenhum administrador tenha sido designado ainda, você pode acionar o bootstrap do primeiro admin abaixo.
            </p>
