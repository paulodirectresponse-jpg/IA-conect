...
import { Download, Edit3, Film, Image as ImageIcon, Loader2, RotateCcw, Search, Sparkles } from 'lucide-react';
...
interface Props {
  ...
  title?: string;
  subtitle?: string;
  liveGeneration?: Generation | null;
