...
export const CreatorPanel: React.FC<Props> = (p) => {
  ...
  return <UniversalCreatorShell
    ...
    footer={<GeneratorFooter
      ...
      primaryLabel={p.hasPendingReferences?'Gerar assim que a imagem enviar':'Gerar vídeo'}
      primaryPrice={!p.hasPendingReferences?p.totalEstimatedCostCents:null}
