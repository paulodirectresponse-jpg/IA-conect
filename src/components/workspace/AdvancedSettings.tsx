...
export const AdvancedSettings: React.FC<AdvancedSettingsProps> = ({
  ...
  const handleRandomizeSeed = () => {
    onChangeSeed(Math.floor(Math.random() * 999999999));
  };
  ...
  return (
    <div className="border-t border-zinc-100 pt-2">
      <button
        ...
        onClick={onToggle}
        className="w-full flex items-center justify-between py-1.5 text-xs font-semibold text-zinc-600 hover:text-zinc-900 transition-colors cursor-pointer"
      >
        ...
        <div className="space-y-3 pt-2 pb-1 animate-in fade-in text-xs">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="text-zinc-600 font-medium">Motion Intensity</label>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <button
                ...
                className="text-[10px] text-emerald-700 hover:text-emerald-800 flex items-center gap-1 cursor-pointer font-medium"
              >
            ...
            <div className="flex gap-1.5">
              <input
                ...
                value={seed}
                onChange={(e) =>
                  onChangeSeed(e.target.value === '' ? '' : parseInt(e.target.value, 10))
                }
