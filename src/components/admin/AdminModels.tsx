  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-2.5 p-3.5 rounded-lg bg-zinc-100 border border-zinc-200/80 text-xs text-zinc-700 leading-relaxed">
        ...
        <div>
          <strong className="text-zinc-900 block mb-0.5">Catálogo de Modelos e Capacidades Técnicas:</strong>
          Os modelos cadastrados abaixo (ex: WAN 2.1, Kling 1.5, Hunyuan) representam <strong>definições de catálogo, limites técnicos e matriz de tarifação</strong> para o Creative Workspace.
        </div>
      </div>
