...
export interface WorkflowAppInputField{node_id:string;label:string;media_type:BetaCapabilityMediaType;required:boolean;placeholder:string;help_text:string;order:number;default_value:any;}
export interface WorkflowAppOutputField{node_id:string;label:string;media_type:BetaCapabilityMediaType;order:number;}
