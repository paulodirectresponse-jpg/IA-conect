...
import { ArrowLeft, Box, FlaskConical, Home, Image as ImageIcon, Library, Music2, Network, Video } from 'lucide-react';
...
export const BetaApp: React.FC<BetaAppProps> = ({ onExit }) => {
  const [view,setView]=useState<'home'|'library'|'audio'|'three-d'|'image-editor'|'video'|'flows'>('home');
