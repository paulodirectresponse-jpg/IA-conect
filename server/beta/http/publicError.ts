...
const RULES:Record<string,Rule>={
  ...
  AI_ACTION_REFERENCE_REQUIRED:{status:409,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  AI_ACTION_BATCH_LIMIT:{status:409,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  AI_ACTION_LOCKED:{status:409,category:'CONFLICT',retryable:false,action:'NONE',preserveMessage:true},
  AI_ACTION_QUOTE_FAILED:{status:503,category:'BILLING',retryable:true,action:'REQUOTE',preserveMessage:true},
  AI_ACTION_CONFIRMATION_REQUIRED:{status:409,category:'BILLING',retryable:false,action:'REQUOTE',preserveMessage:true},
  AI_ACTION_QUOTE_EXPIRED:{status:409,category:'BILLING',retryable:false,action:'REQUOTE',preserveMessage:true},
  AI_ACTION_EXECUTION_FAILED:{status:503,category:'EXECUTION',retryable:true,action:'RETRY',preserveMessage:true},
  AI_ACTION_TOOL_INVALID:{status:409,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  AI_ACTION_RESULT_NOT_FOUND:{status:404,category:'NOT_FOUND',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  AI_ACTION_RETRY_UNAVAILABLE:{status:409,category:'CONFLICT',retryable:false,action:'NONE',preserveMessage:true},
  AI_ACTION_RECOVERED:{status:409,category:'CONFLICT',retryable:true,action:'RETRY',preserveMessage:true},
  ...
  FLOWS_DISABLED:{status:503,category:'SERVICE',retryable:true,action:'RETRY',message:'O editor de Fluxos está temporariamente indisponível.'},
  FLOW_NOT_FOUND:{status:404,category:'NOT_FOUND',retryable:false,action:'NONE',message:'Fluxo não encontrado.'},
  FLOW_REVISION_CONFLICT:{status:409,category:'CONFLICT',retryable:false,action:'RETRY',preserveMessage:true},
  FLOW_GRAPH_INVALID:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_GRAPH_TOO_LARGE:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_EDGE_TYPE_MISMATCH:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_EDGE_PORT_MISMATCH:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_EDGE_PORT_OCCUPIED:{status:409,category:'CONFLICT',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_GRAPH_EMPTY:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_EXECUTION_BLOCKED:{status:409,category:'CONFLICT',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_CYCLE:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_ASSET_REQUIRED:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_RUNTIME_DISABLED:{status:503,category:'SERVICE',retryable:true,action:'RETRY',message:'O runtime de Fluxos está temporariamente indisponível.'},
  FLOW_RUNTIME_EXECUTION_DISABLED:{status:503,category:'SERVICE',retryable:true,action:'RETRY',message:'Novas execuções de Fluxos estão temporariamente pausadas.'},
  FLOW_RUN_NOT_FOUND:{status:404,category:'NOT_FOUND',retryable:false,action:'NONE',message:'Execução de fluxo não encontrada.'},
  FLOW_RUN_RETRY_UNAVAILABLE:{status:409,category:'CONFLICT',retryable:false,action:'NONE',preserveMessage:true},
  FLOW_NODE_RETRY_LIMIT:{status:409,category:'CONFLICT',retryable:false,action:'NONE',message:'O limite de tentativas deste nó foi atingido.'},
  FLOW_OUTPUT_REQUIRED:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_INPUT_REQUIRED:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_INPUT_INVALID:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_INPUT_TYPE_MISMATCH:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_NODE_INVALID:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_NODE_OUTPUT_MISSING:{status:503,category:'EXECUTION',retryable:true,action:'RETRY',preserveMessage:true},
  FLOW_NODE_FAILED:{status:503,category:'EXECUTION',retryable:true,action:'RETRY',preserveMessage:true},
  FLOW_IDEMPOTENCY_INCONSISTENT:{status:409,category:'CONFLICT',retryable:true,action:'RETRY',message:'A execução idempotente não pôde ser recuperada.'},
  FLOW_ECONOMICS_DISABLED:{status:503,category:'SERVICE',retryable:true,action:'RETRY',message:'A economia de Fluxos está temporariamente indisponível.'},
  FLOW_BUDGET_GUARD_DISABLED:{status:503,category:'SERVICE',retryable:true,action:'RETRY',message:'A proteção de orçamento de Fluxos está temporariamente indisponível.'},
  FLOW_BUDGET_INVALID:{status:400,category:'VALIDATION',retryable:false,action:'CHANGE_INPUT',preserveMessage:true},
  FLOW_BUDGET_INSUFFICIENT_CREDITS:{status:402,category:'BILLING',retryable:false,action:'ADD_CREDITS',preserveMessage:true},
  FLOW_BUDGET_EXCEEDED:{status:409,category:'BILLING',retryable:false,action:'REQUOTE',preserveMessage:true},
  FLOW_BUDGET_REQUIRED:{status:409,category:'BILLING',retryable:false,action:'REQUOTE',message:'Autorize um orçamento antes de continuar este Flow.'},
  FLOW_QUOTE_NOT_FOUND:{status:404,category:'NOT_FOUND',retryable:false,action:'REQUOTE',message:'Autorização econômica do Flow não encontrada.'},
  FLOW_QUOTE_REVISION_CHANGED:{status:409,category:'BILLING',retryable:false,action:'REQUOTE',message:'O Flow mudou. Gere uma nova autorização de orçamento.'},
  FLOW_QUOTE_EXPIRED:{status:409,category:'BILLING',retryable:false,action:'REQUOTE',message:'A autorização de orçamento expirou.'},
  FLOW_ECONOMICS_CONFLICT:{status:409,category:'CONFLICT',retryable:false,action:'NONE',message:'A execução já possui outra autorização econômica.'},
