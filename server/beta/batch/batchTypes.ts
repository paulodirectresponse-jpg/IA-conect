...
export interface BatchItem{item_id:string;index:number;status:BatchItemStatus;input:Record<string,any>;flow_run_id:string|null;error_code:string|null;error_message:string|null;created_at:string;updated_at:string;}
