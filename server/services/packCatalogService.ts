...
const COMMERCIAL_PLANS:PackVersion[]=[
  ...
  },
  {
    pack_id:'pro',
    version:1,
    price_brl_cents:7990,
    base_credits:8000,
    bonus_credits:400,
    total_credits:8400,
    active:true,
    effective_from:'2026-09-25T00:00:00.000Z',
    label:'8.400 créditos',
    name:'Pro',
    description:'Para criadores que usam IA toda semana e precisam de mais volume.',
    badge:'Mais escolhido',
    recommended:true,
    features:['Tudo do Creator','400 créditos extras incluídos','Melhor custo por geração que o Creator'],
  },
  {
    pack_id:'studio',
    version:1,
    price_brl_cents:14990,
    base_credits:15000,
    bonus_credits:1500,
    total_credits:16500,
    active:true,
    effective_from:'2026-09-25T00:00:00.000Z',
    label:'16.500 créditos',
    name:'Studio',
    description:'Para produção recorrente, equipes pequenas e maior volume mensal.',
    badge:'Melhor valor',
    features:['Tudo do Pro','1.500 créditos extras incluídos','Menor custo efetivo por crédito entre os três planos'],
  },
];
